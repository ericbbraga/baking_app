...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void createRecipeTable(SQLiteDatabase sqLiteDatabase) {
        String recipeSqlCreate = String.format(
                    ...
                    BakingContract.RecipeEntry.STARRED_COLUMN
            );
    ...
    private void createReferenceTables(SQLiteDatabase sqLiteDatabase) {
        createRecipeIngredientTable(sqLiteDatabase);
        createRecipeStepTable(sqLiteDatabase);

    }

    private void createRecipeIngredientTable(SQLiteDatabase sqLiteDatabase) {
    ...
    private void createRecipeStepTable(SQLiteDatabase sqLiteDatabase) {
